...
const S3REGION: string = 'insert your region here'; //You should write where your s3 bucket is located.
const S3ACCESSKEYID: string = 'insert your access key here'; //You should write access key id for your/company aws account. BEST TO USE IT AS ENVIRONMENT VARIABLE.
const S3SECRETACCESSKEY: string = 'insert your secret access key here'; //You should write the secret access key for your/company aws account. BEST TO USE IT AS ENVIRONMENT VARIABLE.
const S3BUCKETNAME: string = 'insert your bucket name here'; //You should write the bucket name of your/company aws account. BEST TO USE IT AS ENVIRONMENT VARIABLE.
...
export const generateInvoice =  async (req: Request, res: Response, next: NextFunction): Promise <Response> => {
    ...
    const response: ResponseInterface = await invoice.generateInvoice(items, S3APIVERSION, S3REGION, S3ACCESSKEYID, S3SECRETACCESSKEY, S3BUCKETNAME);
